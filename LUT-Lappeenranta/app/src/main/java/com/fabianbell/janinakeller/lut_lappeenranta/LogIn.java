...
public class LogIn extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener {
    ...
    private void createTestShops(Firebase mRootRef) {
        Firebase shop = mRootRef.child("Shop");

        shop.push().setValue("Samsung");
        shop.push().setValue("Apple");
        shop.push().setValue("Fabian");
        shop.push().setValue("Janina");
    }
